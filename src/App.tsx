...
export default function App() {
  ...
  return (
    ...
    >
      ...
      {isPlaceholderRoute(route) && !["application-detail", "applications", "candidates", "inbox", "email-agent", "inbox-detail"].includes(route) ? <PlaceholderPage route={route} title={placeholderLabels[route]} /> : null}
    </AppShell>
  );
}
